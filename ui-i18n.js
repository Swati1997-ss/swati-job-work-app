(() => {
  ...
  const GU_TO_EN = {
    ...
    'આજની સ્થિતિ':'Today’s Position',
    'હાથ પરની રકમ':'Liquid Money',
    'લેવાની રકમ':'Receivables',
    'ચૂકવવાની રકમ':'Payables',
    'સ્ટોકની કિંમત':'Stock Value',
    'રોકડ + બેંક':'Cash + Bank',
    'ગ્રાહકો પાસેથી લેવાની':'Money to receive',
    'પાર્ટીઓને ચૂકવવાની':'Money to pay',
    'સ્ટોકમાં રોકાયેલી રકમ':'Money tied in inventory',
    'આજનો ધંધો':'Today’s Business',
    'ધ્યાન આપવું જરૂરી':'Needs Attention',
    'ધંધાની સ્થિતિ':'Business Position',
